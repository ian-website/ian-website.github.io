...
BLOG_AUTHOR = "Georgie Dansey"  # (translatable)
#BLOG_TITLE = {"ja": "氏名", "en": "Kanako", } # (translatable)
BLOG_TITLE = {"en": "Georgie Dansey", } # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ian-website.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://ian-website.github.io/"
BLOG_EMAIL = "georgie.dansey@parliament.govt.nz"
BLOG_DESCRIPTION = "Georgie's website on Github"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ('/index.html', ''),  #' Leave blank Use: Georgie Dansey title. - Georgie'), # Change Home to Georgie?
        #(
        #    (
        #        # ('/en/hamilton/introduction/', 'Introduction'),
        #        ('/hamilton/city/', 'City'),
        #        ('/hamilton/bus/', 'Bus'),
        #        ('/hamilton/train/', 'Train'),
        #        ('/hamilton/shop/', 'Shopping'),
        #    ),
        #    'Hamilton'
        #),
        ("/meeting/", "Community Clinic"),
        ("/contact/", "Contact"),    
        #("/download/", "Download"),
        ("/about/", "About"),
    ),
...
# Ian
POSTS = ()
# Ian. Was:  ("pages/*.rst", "pages", "page.tmpl"),
...
# Ian
FRONT_INDEX_HEADER = {
    DEFAULT_LANG: '<p> This is Front Index Header for the default language</p>'
}
...
# )
FAVICONS = (
     ("icon", "/images/favicon-fern.png", "16 x 16"),
     ("icon", "/images/favicon-fern.png", "24 x 24"),
     ("icon", "/images/favicon-fern.png", "32 x 32"),     
)
